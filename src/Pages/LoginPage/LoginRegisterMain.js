  ...
  return (
    <section>
      <div className="loginRegisterToggleBtn">
        <button
          id={loginArea ? "activeArea" : "deactiveArea"}
          className="loginTogglerBtn"
          onClick={() => {
        ...
        <button
          id={registerArea ? "activeArea" : "deactiveArea"}
          className="registerTogglerBtn"
          onClick={() => {
            setLoginArea(false);
      ...
      <div className="formAccountsCreatingArea">
        {loginArea && (
          <Login
            ...
            manualyLogin={handleManualyLogin}
          />
        )}
        {registerArea && (
          <Register
            loadingGif2={loading}
            createAccount={handleManualyCreateAccount}
          />
        )}
      </div>{" "}
      <br />
