  ...
  if(success){
    ...
    return (
        <section>
            ...
            {loading ? <div style={{margin: 'auto', textAlign: 'center', marginTop: '50px'}}><CircularProgress sx={{ textAlign: 'center', margin: 'auto'}} mt={3} color="secondary" /></div>: <section style={{marginTop: '100px'}}>
              <Container>              
